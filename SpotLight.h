...
public:		//アクセッサ
	...
	inline void SetLightFactorAngle(const XMFLOAT2& lightFactorAngle) {
		this->lightFactorAngleCos.x = cos(DirectX::XMConvertToRadians(lightFactorAngle.x));
		this->lightFactorAngleCos.y = cos(DirectX::XMConvertToRadians(lightFactorAngle.y));
	}
